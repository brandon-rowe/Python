...
class MainPage(GridLayout):
    def __init__(self, **kwargs):
        ...
        ## View Record Button
        self.join = Button(text="View Record")
...
class AddPage(GridLayout):
    def __init__(self, **kwargs):
        super().__init__(**kwargs)
        self.cols=2

        ##  Order Number 
        self.add_widget(Label(text="Order Number:"))
        ...
        ##  Ship Via 
        self.add_widget(Label(text="Ship Via:"))
        self.shipVia = TextInput(multiline=False)
        self.add_widget(self.shipVia)

        ##  Order Date 
        self.add_widget(Label(text="Order Date:"))
    ...
    def join_button(self, instance):
        ...
        info = f"{orderNum}\t\t{customer}\t\t{shipVia}\t\t{orderDate}"
        order_app.view_page.update_info(info)
        order_app.screen_manager.current = "View"
        

class ViewPage(GridLayout):
    def __init__(self, **kwargs):
        super().__init__(**kwargs)
        self.cols = 1
